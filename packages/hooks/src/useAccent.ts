...
export const useAccent = (palettes: any, initial: PaletteType = 'greens', accentFunction: ((key: PaletteType) => string[]) | null = null): UseAccentType => {
  ...
  useEffect(() => void requestAnimationFrame(() => {
    ...
    const newColours = (accentFunction && accentFunction(accent as PaletteType)) || [...palettes[accent as PaletteType]] as string[];
