...
export const textField = () => (
  <Form>
    <InputField label="label" id="text_1" />
    <InputField label="label" hint="hint text" id="text_2" />
    <InputField label="label" invalid="invalid text" id="text_3" />
    <InputField label="required field" required id="text_4" />
    <InputField label="disabled field" disabled id="text_5" />
  </Form>
);
