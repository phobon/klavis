...
const longText =
  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id sodales lectus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque id sodales lectus.";
...
export const withWrappingText = () => {
  ...
  return <Table columns={columnData} rows={rows} />;
};
...
export const withTruncatedText = () => {
  ...
  return (
    <Box flexDirection="column" fullWidth>
      <Table columns={firstColumnData} rows={firstRows} />

      <Table mt={5} columns={secondColumnData} rows={secondRows} />
    </Box>
  );
};
...
export const withDifferentInformationDensities = () => {
  ...
  return (
    <Box flexDirection="column" fullWidth alignItems="flex-start">
      ...
      <Table mb={6} columns={firstColumnData} rows={firstRows} />

      <Heading as="h6" mb={3}>
        Spacious density
      </Heading>
      <Table density="spacious" columns={firstColumnData} rows={firstRows} />
    </Box>
  );
};
